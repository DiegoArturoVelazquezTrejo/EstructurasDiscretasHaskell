module Peliculas where
  ...
  movies = [("life of pi", "\128047 \128675 \128115"),
                    ...
                    ("notebook", "\9999\65039 \128211 \128116 \128117"),
                    ...
                    ("social network", "\128100 \128187"),
                    ("santa clause", "\128104 \127877"),
                    ...
                    ("miserables", "\127467\127479 \127926 \128135"),
                    ("king speech", "\128081 \128172 \127897"),
                    ...
                    ("bugs life", "\127793 \128028 \128030 \128038"),
                    ...
                    ("clockwork orange", "\9200 \128295 \127818"),
                    ("perfect storm", "\128076 \127783 \9889\65039"),
                    ...
                    ("little mermaid", "\129500 \128305 \129408 \128031"),
                    ("gift", "\128230 \127872"),
                    ...
                    ("wolf of wall street", "\128058\128509\128176"),
                    ...
                    ("breakfast club", "\127859 \9749\65039 \127849 \9827\65039"),
                    ...
                    ("shape of water", "\128031 \10084\65039 \128105"),
                    ...
                    ("grand budapest hotel","\127976 \127469\127482 \128155"),
  ...
  instrucciones ="\n\n"++"INSTRUCCIONES∷"++"\n\n" ++ 
                      "A través de los emojis que se presentan, intenta descifrar el nombre de a película." ++ "\n" ++
                      "Nota: Los nombres tienen que ser ingresados en inglés." ++ "\n\n" ++
                      "Selecciona en el menú la opción 1 para poder ingresar al juego." ++ "\n\n" ++
                      "Selecciona en el menú la opción 2 para abrir las instrucciones." ++ "\n\n" ++
                      "Selecciona en el menú la opción 3 para cerrar el juego."++ "\n"
